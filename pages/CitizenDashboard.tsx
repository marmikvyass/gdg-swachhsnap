...
import { checkHighPriorityOSM } from "../services/osmPriority";
...
export const CitizenDashboard: React.FC = () => {
  ...
  const submitReport = async (image: string) => {
    ...
    try {
      ...
      const isHighPriority = await checkHighPriorityOSM(
        latitude,
        longitude
      );
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {CATEGORIES.map((cat) => (
            <button
              ...
              className={`p-4 rounded-xl border-2 flex flex-col items-center ${category === cat.value
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`mt-4 px-4 py-2 rounded text-xs font-bold ${joined
            ...
            >
              ...
              <div className="p-5">
                <div className="flex justify-between">
                  ...
                  <span
                    className={`text-xs font-bold px-2 py-1 rounded ${STATUS_COLORS[c.status]
                      }`}
                  >
                    {c.status}
                  </span>
